...
This repository contains the official training/evaluation code of the [TwigVLM paper](https://arxiv.org/abs/2503.14075) (accepted by ICCV '25). TwigVLM is a simple yet framework to accelerate inference of large visual language models (LVLMs) by “growing” a lightweight twig block on top of an early layer of the base VLM.
