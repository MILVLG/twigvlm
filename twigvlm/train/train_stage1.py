...
twig_K = os.environ.get('twig_K', 2)
twig_K = int(twig_K)
twig_T = os.environ.get('twig_T', 3)
twig_T = int(twig_T)
...
from twigvlm.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
from torch.utils.data import Dataset
from twigvlm.train.llava_trainer import LLaVATrainer

from twigvlm import conversation as conversation_lib
from twigvlm.model import *
from twigvlm.mm_utils import tokenizer_image_token
...
def train():
    ...
    del model.get_model().layers[:twig_K]
