...
from twig_inference.constants import IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
...
from twig_inference.utils import disable_torch_init
from twig_inference.mm_utils import tokenizer_image_token, process_images, get_model_name_from_path
...
def eval_model(args):
    ...
    tokenizer, model, image_processor, context_len = load_pretrained_model(model_path, args.model_base, model_name, attn_implementation="flash_attention_2", branch=args.branch)
