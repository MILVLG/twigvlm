...
deepspeed twigvlm/train/train_stage2.py \
    --deepspeed ./scripts/zero2.json \
    --data_path $DATA_PATH \
    --image_folder $IMAGE_FOLDER \
    --model_name_or_path $MODEL_NAME_OR_PATH \
    --twig_path $TWIG_STAGE1_PATH \
    --version v1 \
    ...
    --bf16 True \
    --output_dir ./checkpoints/TwigVLM++-stage2-llava1.5-7b-K${twig_K}-T${twig_T} \
    --num_train_epochs 1 \
    ...
    --report_to none | tee logs/$(date +"%Y-%m-%d_%H_%M").log
